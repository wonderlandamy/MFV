...
_C.MODEL.BOT_DEPTH = 3

_C.MODEL.TFC_DEPTH = [3, 3, 6]

_C.MODEL.IN_DIM = [256, 512, 1024]
...
_C.DATASETS.ROOT_DIR = ('reid_dataset')
...
_C.TEST.WEIGHT = '/root/autodl-tmp/hat/train_weight/train.pth'
